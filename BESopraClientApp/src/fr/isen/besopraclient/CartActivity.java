...
public class CartActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ImageButton b = (ImageButton) this.findViewById(R.id.imageButtonCart);
		b.setImageResource(R.drawable.ic_cart_back);
	}
	...
	public void changeActivityClick(View v){
		...
		if(tag.equals("account")){
			...
			Intent intent = new Intent(CartActivity.this, AdviserActivity.class);
			startActivity(intent);
			finish();
		}
	}
